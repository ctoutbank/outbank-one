...
import { customers, paymentInstitution, solicitationFee, settlements, paymentLink, shoppingItems, reports, reportFilters, reportFiltersParam, solicitationFeeBrand, merchantPixSettlementOrders, merchants, merchantSettlements, solicitationBrandProductType, merchantfile, file, userMerchants, users, solicitationFeeDocument, profiles, profileFunctions, functions, merchantPriceGroup, merchantTransactionPrice, payoutAntecipations, merchantSettlementOrders, salesAgents, modules, moduleFunctions, categories, legalNatures, configurations, addresses, merchantPrice, merchantBankAccounts, merchantpixaccount, customerFunctions, contacts, payout, reportExecution, reportExecutionStatus } from "./schema";
