import { pgTable, foreignKey, varchar, bigint, boolean, timestamp, integer, numeric, date, unique, serial, char, text, uuid, time, index, jsonb } from "drizzle-orm/pg-core"
...
export const customers = pgTable("customers", {
	...
	return {
		customersIdParentFkey: foreignKey({
...
export const paymentInstitution = pgTable("payment_institution", {
	...
	return {
		paymentInstitutionIdCustomerDbFkey: foreignKey({
...
export const solicitationFeeBrand = pgTable("solicitation_fee_brand", {
	...
	return {
		solicitationFeeBrandSolicitationFeeIdFkey: foreignKey({
...
export const userMerchants = pgTable("user_merchants", {
	...
	return {
		userMerchantsIdMerchantFkey: foreignKey({
			columns: [table.idMerchant],
			foreignColumns: [merchants.id],
			name: "user_merchants_id_merchant_fkey"
		}),
		userMerchantsIdUserFkey: foreignKey({
...
export const solicitationFeeDocument = pgTable("solicitation_fee_document", {
	...
	return {
		solicitationFeeDocumentIdFileFkey: foreignKey({
			columns: [table.idFile],
			foreignColumns: [file.id],
			name: "solicitation_fee_document_id_file_fkey"
		}).onDelete("cascade"),
		solicitationFeeDocumentSolicitationFeeIdFkey: foreignKey({
			columns: [table.solicitationFeeId],
			foreignColumns: [solicitationFee.id],
...
export const userNotifications = pgTable("user_notifications", {
	...
	return {
		userNotificationsIdUserFkey: foreignKey({
			columns: [table.idUser],
			foreignColumns: [users.id],
...
export const merchants = pgTable("merchants", {
	...
	return {
		...
		merchantsIdCustomerFkey: foreignKey({
			columns: [table.idCustomer],
			foreignColumns: [customers.id],
			name: "merchants_id_customer_fkey"
		}),
		merchantsIdMerchantBankAccountFkey: foreignKey({
...
export const fornecedorCategories = pgTable("fornecedor_categories", {
	...
	return {
		idxFornecedorCategoriesCategory: index("idx_fornecedor_categories_category").using("btree", table.categoryId.asc().nullsLast().op("int8_ops")),
		idxFornecedorCategoriesFornecedor: index("idx_fornecedor_categories_fornecedor").using("btree", table.fornecedorId.asc().nullsLast().op("uuid_ops")),
		fkFornecedorCategoriesFornecedor: foreignKey({
			columns: [table.fornecedorId],
			foreignColumns: [fornecedores.id],
			name: "fk_fornecedor_categories_fornecedor"
		}).onDelete("cascade"),
		fkFornecedorCategoriesCategory: foreignKey({
			columns: [table.categoryId],
			foreignColumns: [categories.id],
			name: "fk_fornecedor_categories_category"
		}).onDelete("cascade"),
		fornecedorCategoriesFornecedorIdCategoryIdKey: unique("fornecedor_categories_fornecedor_id_category_id_key").on(table.fornecedorId, table.categoryId),
	}
});
...
export const solicitationBrandProductType = pgTable("solicitation_brand_product_type", {
	...
	return {
		solicitationBrandProductTypeSolicitationFeeBrandIdFkey: foreignKey({
...
export const fee = pgTable("fee", {
	...
	return {
		feeIdCustomerFkey: foreignKey({
			columns: [table.idCustomer],
			foreignColumns: [customers.id],
			name: "fee_id_customer_fkey"
		}),
	}
});
...
export const financialAdjustmentMerchants = pgTable("financial_adjustment_merchants", {
	...
	return {
		financialAdjustmentMerchantsIdFinancialAdjustmentFkey: foreignKey({
		...
		financialAdjustmentMerchantsIdMerchantFkey: foreignKey({
			columns: [table.idMerchant],
			foreignColumns: [merchants.id],
...
export const financialAdjustments = pgTable("financial_adjustments", {
	...
	return {
		financialAdjustmentsIdCustomerFkey: foreignKey({
			columns: [table.idCustomer],
			foreignColumns: [customers.id],
			name: "financial_adjustments_id_customer_fkey"
		}),
	}
});
...
export const reports = pgTable("reports", {
	...
	referenceDateType: varchar("reference_date_type", { length: 20 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	idCustomer: bigint("id_customer", { mode: "number" }),
}, (table) => {
	return {
		reportsIdCustomerFkey: foreignKey({
			columns: [table.idCustomer],
			foreignColumns: [customers.id],
			name: "reports_id_customer_fkey"
		}),
	}
});
...
export const customerCustomization = pgTable("customer_customization", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({ name: "customer_customization_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	slug: varchar({ length: 50 }),
	name: varchar({ length: 100 }),
	...
	return {
		customerCustomizationCustomerIdFkey: foreignKey({
			columns: [table.customerId],
			foreignColumns: [customers.id],
			name: "customer_customization_customer_id_fkey"
		}),
		customerCustomizationFileIdFkey: foreignKey({
			columns: [table.fileId],
			foreignColumns: [file.id],
			name: "customer_customization_file_id_fkey"
		}),
	}
});
...
export const merchantSettlements = pgTable("merchant_settlements", {
	...
	return {
		merchantsettlementsIdMerchantFkey: foreignKey({
			columns: [table.idMerchant],
			foreignColumns: [merchants.id],
			name: "merchantsettlements_id_merchant_fkey"
		}),
		merchantsettlementsIdCustomerFkey: foreignKey({
			columns: [table.idCustomer],
			foreignColumns: [customers.id],
			name: "merchantsettlements_id_customer_fkey"
		}),
		merchantsettlementsIdSettlementFkey: foreignKey({
...
export const merchantSettlementOrders = pgTable("merchant_settlement_orders", {
	...
	return {
		merchantSettlementOrdersIdPaymentInstitutionFkey: foreignKey({
		...
		merchantSettlementOrdersIdMerchantSettlementsFkey: foreignKey({
...
export const fornecedorDocuments = pgTable("fornecedor_documents", {
	...
	return {
		idxDocumentsFornecedor: index("idx_documents_fornecedor").using("btree", table.fornecedorId.asc().nullsLast().op("uuid_ops")),
		fkDocumentFornecedor: foreignKey({
			columns: [table.fornecedorId],
			foreignColumns: [fornecedores.id],
...
export const fornecedores = pgTable("fornecedores", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	nome: varchar({ length: 225 }).notNull(),
	...
	cnaeCodigo: varchar("cnae_codigo", { length: 7 }),
	...
	return {
		idxFornecedoresAtivo: index("idx_fornecedores_ativo").using("btree", table.ativo.asc().nullsLast().op("bool_ops")),
		idxFornecedoresCnpj: index("idx_fornecedores_cnpj").using("btree", table.cnpj.asc().nullsLast().op("text_ops")),
		idxFornecedoresNome: index("idx_fornecedores_nome").using("btree", table.nome.asc().nullsLast().op("text_ops")),
		fornecedoresCnpjKey: unique("fornecedores_cnpj_key").on(table.cnpj),
	}
});
...
export const merchantPixSettlementOrders = pgTable("merchant_pix_settlement_orders", {
	...
	return {
		merchantPixSettlementOrdersIdCustomerFkey: foreignKey({
			columns: [table.idCustomer],
			foreignColumns: [customers.id],
			name: "merchant_pix_settlement_orders_id_customer_fkey"
		}),
		merchantPixSettlementOrdersIdMerchantFkey: foreignKey({
			columns: [table.idMerchant],
			foreignColumns: [merchants.id],
			name: "merchant_pix_settlement_orders_id_merchant_fkey"
		}),
		merchantPixSettlementOrdersIdMerchantSettlementFkey: foreignKey({
