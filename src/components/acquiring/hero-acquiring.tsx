      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 md:pt-32">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="w-full lg:max-w-xl text-center lg:text-left">
            ...
            {t('Become an acquirer and explore new revenue opportunities')}
            </h1>
            
            <p className="text-gray-300 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 px-4 sm:px-0">
            {t('Count on Dock to access all the necessary infrastructure to have your own white-label acquiring platform.')}            </p>
