      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative">
          ...
          <div className="mb-0 mt-8 md:mt-0 text-center md:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-gray-100 mb-6">
              Technology for you to be your own acquirer
            </h2>

            <p className="text-gray-300/80 text-lg mb-8">
              Offer acquiring services with a white-label platform. Discover how your own acquiring operation can
            ...
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gradient-to-r from-[#2c2c2c] to-[#080808] p-6 rounded relative">
                  ...
                  <p className="text-gray-300/80 pr-12">Offer the acquisition service and expand your service portfolio.</p>
                </div>
                ...
                <div className="bg-gradient-to-r from-[#2c2c2c] to-[#080808] p-6 rounded relative">
                  ...
                  <p className="text-gray-300/80 pr-12">Use it as a monetization strategy and reinforce your brand.</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#2c2c2c] to-[#080808] p-6 rounded relative">
                ...
                <p className="text-gray-300/80 pr-12">
                  No intermediaries. Become a White label acquirer, adding new revenue to your company.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="-mt-20 md:-mt-40">
          <h2 className="text-4xl md:text-5xl font-light text-gray-100 mb-8">
            Count on our complete solution
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Acquiring Box */}
            <div className="bg-gradient-to-r from-[#2c2c2c] to-[#080808] p-8 rounded-lg">
              <p className="text-gray-300 text-lg mb-6">Acquiring processing and transactions settlement</p>
            ...
            {/* Back-office Box */}
            <div className="bg-gradient-to-r from-[#2c2c2c] to-[#080808] p-8 rounded-lg">
              <p className="text-gray-300 text-lg mb-6">Back-office structure for operation management</p>
