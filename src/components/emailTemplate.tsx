...
const EmailTemplate: React.FC<SimplePurchaseEmailProps> = ({
  purchaseLink,
  bankName = "Banco Prisma (Outbank)",
}) => {
  // This function returns the HTML string that can be used as an email template
  ...
  // For preview purposes in Next.js
