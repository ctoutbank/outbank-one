...
import { getLegalNatures } from "@/server/db/legalNature";
import LegalNaturelist from "./list";
...
type LegalNatureProps = {
    ...
    return(
        <>
        <BaseHeader
        breadcrumbItems={[{ title: "Natureza Jurídica", url: "/portal/legalNatures" }]}
        />
        ...
        <ListFilter
        pageName="portal/legalNatures" search={search} linkHref={"/portal/legalNatures/0"  } linkText={"Nova Natureza Jurídica"} />
