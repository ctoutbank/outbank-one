                                  ...
                                  <CardContent className="p-4">
                                      ...
                                      <div className="text-center mb-4">
                                          <div className="flex items-center gap-2 mb-3">
                                              ...
                                              <span className="text-base font-medium">Total de Naturezas Jurídicas</span>
                                          </div>
                                          <div className="text-2xl font-bold text-zinc-900">{totalLegalNatures}</div>
                                          <div className="text-xs text-muted-foreground mt-1">Total de Naturezas Jurídicas</div>
                                      </div>
                                      ...
                                      <div className="grid grid-cols-2 gap-2">
                                          <div className="text-center">
                                              ...
                                              <div className="text-sm font-semibold text-zinc-900">{activeLegalNatures}</div>
                                          </div>
                                          ...
                                          <div className="text-center">
                                              ...
                                              <div className="text-sm font-semibold text-zinc-900">{inactiveLegalNatures}</div>
                                          </div>
                                      </div>
                                  </CardContent>
                              </Card>
