...
import { ChevronLeft, ChevronRight, Building2, UserCheck, Users } from "lucide-react"
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-zinc-600">Estabelecimentos</span>
              </div>
              <span className="text-2xl font-semibold text-zinc-900 ml-4">{totalMerchant}</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white min-w-[280px]">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-2xl font-semibold text-zinc-900 ml-4">{totalSales}</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                ...
                <span className="text-base font-semibold text-zinc-900">{formatCurrency(grossAmount)}</span>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 mb-1.5">
                ...
                <span className="text-base font-semibold text-zinc-900">{formatCurrency(taxAmount)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center">
                  <button onClick={toggleView} className="text-sm font-medium text-zinc-600 hover:text-zinc-900">
        ...
        <Card className="bg-white min-w-[280px]">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <Users className="h-4 w-4 text-zinc-500" />
                <span className="text-sm font-medium text-zinc-600">Parcelas a Liquidar</span>
              </div>
              <span className="text-2xl font-semibold text-zinc-900 ml-4">{toSettleInstallments}</span>
            </div>
            <Separator className="mb-3" />
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                ...
                <span className="text-base font-semibold text-zinc-900">{formatCurrency(toSettleGrossAmount)}</span>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 mb-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-blue-500" />
                ...
                <span className="text-base font-semibold text-zinc-900">{formatCurrency(toSettleTaxAmount)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
