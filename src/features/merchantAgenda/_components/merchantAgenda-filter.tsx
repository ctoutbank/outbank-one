...
export function MerchantAgendaFilter(props: MerchantAgendaFilterProps) {
    ...
    const handleFilter = async (filters: {
        ...
        try {
            ...
            if (filters.dateFrom) {
                params.set("transactionDateFrom", filters.dateFrom.toISOString());
            } else {
                params.delete("transactionDateFrom");
            }
            if (filters.dateTo) {
                params.set("transactionDateTo", filters.dateTo.toISOString());
            } else {
                params.delete("transactionDateTo");
            }
    ...
    const activeFiltersCount =
        (props.transactionDateFrom ? 1 : 0) +
        (props.transactionDateTo ? 1 : 0) +
    ...
    return (
        ...
        >
            <MerchantAgendaFilterModalContent
                dateFromIn={props.transactionDateFrom ? new Date(props.transactionDateFrom) : undefined}
                dateToIn={props.transactionDateTo ? new Date(props.transactionDateTo) : undefined}
