...
import { insertContactFormAction, updateContactFormAction } from "../_actions/contact-formActions";
...
export default function MerchantFormcontact({ Contact, Address, onAdvance }: MerchantProps ) {
    ...
    const onSubmit = async (data: ContactSchema) => {
      try {
        if (data?.id) {
          await updateContactFormAction(data);
        } else {
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="yes" id="owner-yes" checked={field.value === true} />
                            <Label htmlFor="owner-yes">Sim</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="no" id="owner-no" checked={field.value === false} />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="yes" id="pep-yes" checked={field.value === true} />
                            <Label htmlFor="pep-yes">Sim</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="no" id="pep-no" checked={field.value === false} />
