...
export function MerchantDashboardContent({
  ...
  const shiftChartData = prepareChartData(shiftData, ["Manhã", "Tarde", "Noite", "Madrugada"])
  const hasShiftData = shiftData.some((item) => item.value > 0)

  // Preparar outros dados com fallback
  const transactionChartData = prepareChartData(transactionData, ["Transaciona", "Não Transaciona"])
  ...
  const regionChartData = prepareChartData(regionData, ["Norte", "Nordeste", "Centro-Oeste", "Sudeste", "Sul"])
  const hasRegionData = regionData.some((item) => item.value > 0)

  const statusChartData = prepareChartData(statusData, ["Aprovadas", "Negadas"])
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="h-[165px] p-4 bg-transparent rounded-lg border flex flex-col justify-between">
                    <div>
                      ...
                      <div className="text-center mb-4">
                        <div className="text-lg font-bold text-zinc-900">{totalMerchants}</div>
                      </div>
                    </div>
                    <div className="flex flex-col ">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-semibold">{activeMerchants}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold">{inactiveMerchants}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="h-[165px] p-4 bg-transparent rounded-lg border flex flex-col justify-between">
                    <div>
                      ...
                      <div className="text-center mb-4">
                        <div className="text-lg font-bold text-zinc-900">{approvedKyc + pendingKyc + rejectedKyc}</div>
                      </div>
                    </div>
                  ...
                  <div className="h-[165px] p-4 bg-transparent rounded-lg border flex flex-col justify-between">
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-semibold">{totalCpAnticipation}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold">{totalCnpAnticipation}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="h-[165px] p-4 bg-transparent rounded-lg border flex flex-col justify-between">
                    <div>
                      ...
                      <div className="text-center mb-4">
                        <div className="text-lg font-bold text-zinc-900">{registrationSummary.currentMonth}</div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="text-center">
                        ...
                        <div className="text-xs font-bold">{registrationSummary.previousMonth}</div>
                      </div>
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-1 mb-1">
                        ...
                        <div className="text-xs font-bold">{registrationSummary.currentWeek}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                  ...
                  <div className="min-h-[200px] p-4 bg-transparent rounded-lg border">
                    <div className="text-xs font-small mb-2">
                      ...
                      {!hasTransactionData && <span className="text-gray-400 ml-1">(Sem dados)</span>}
                    </div>
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                              ...
                              outerRadius="45%"
                              dataKey="value"
                              label={hasTransactionData ? ({ percent }) => `${(percent * 100).toFixed(0)}%` : () => ""}
                          >
                            {transactionChartData.map((entry, index) => (
                                <Cell
                                    key={`cell-${index}`}
                                    fill={TRANSACTION_COLORS[index % TRANSACTION_COLORS.length]}
                                    opacity={hasTransactionData ? 1 : 0.3}
                                />
                            ))}
                          </Pie>
                          <Tooltip content={<CustomTooltip hasData={hasTransactionData} />} />
                        </PieChart>
                      </ResponsiveContainer>
                    </div>
                      ...
                      {transactionChartData.map((entry, index) => (
                          <div key={entry.name} className="flex items-center gap-1">
                            <div
                                ...
                                style={{
                                  backgroundColor: TRANSACTION_COLORS[index % TRANSACTION_COLORS.length],
                                  opacity: hasTransactionData ? 1 : 0.3,
                                }}
                            />
                            <span className={`text-xs ${hasTransactionData ? "text-gray-600" : "text-gray-400"}`}>
                          {entry.name}
                        </span>
                          </div>
                      ))}
                  ...
                  <div className="min-h-[200px] p-4 bg-transparent rounded-lg border">
                    <div className="text-xs font-small mb-2">
                      ...
                      {!hasTypeData && <span className="text-gray-400 ml-1">(Sem dados)</span>}
                    </div>
                    <div className="h-[120px] flex items-center justify-center">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                              ...
                              outerRadius="45%"
                              dataKey="value"
                              label={hasTypeData ? ({ percent }) => `${(percent * 100).toFixed(0)}%` : () => ""}
                          >
                          ...
                          <Tooltip content={<CustomTooltip hasData={hasTypeData} />} />
                        </PieChart>
                      </ResponsiveContainer>
                    </div>
                    <div className="flex flex-wrap justify-center gap-1 mt-2">
                      {typeChartData.map((entry, index) => (
                          <div key={entry.name} className="flex items-center gap-1">
                            ...
                            />
                            <span className={`text-xs ${hasTypeData ? "text-gray-600" : "text-gray-400"}`}>
                          {entry.name}
                        </span>
                          </div>
                      ))}
                  ...
                  <div className="min-h-[200px] p-4 bg-transparent rounded-lg border">
                    <div className="text-xs font-small mb-2">
                      ...
                      {!hasShiftData && <span className="text-gray-400 ml-1">(Sem dados)</span>}
                    </div>
                    <div className="h-[120px] flex items-center justify-center">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                              ...
                              outerRadius="45%"
                              dataKey="value"
                              label={hasShiftData ? ({ percent }) => `${(percent * 100).toFixed(0)}%` : () => ""}
                          >
                          ...
                          <Tooltip content={<CustomTooltip hasData={hasShiftData} />} />
                        </PieChart>
                      </ResponsiveContainer>
                    </div>
                    <div className="flex flex-wrap justify-center gap-1 mt-2">
                      {shiftChartData.map((entry, index) => (
                          <div key={entry.name} className="flex items-center gap-1">
                            ...
                            />
                            <span className={`text-xs ${hasShiftData ? "text-gray-600" : "text-gray-400"}`}>
                          {entry.name}
                        </span>
                          </div>
                      ))}
                  ...
                  <div className="min-h-[200px] p-4 bg-transparent rounded-lg border">
                    <div className="text-xs font-small mb-2">
                      ...
                      {!hasRegionData && <span className="text-gray-400 ml-1">(Sem dados)</span>}
                    </div>
                    <div className="h-[120px] flex items-center justify-center">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                              ...
                              outerRadius="45%"
                              dataKey="value"
                              label={hasRegionData ? ({ percent }) => `${(percent * 100).toFixed(0)}%` : () => ""}
                          >
                          ...
                          <Tooltip content={<CustomTooltip hasData={hasRegionData} />} />
                        </PieChart>
                      </ResponsiveContainer>
                    </div>
                    <div className="flex flex-wrap justify-center gap-1 mt-2">
                      {regionChartData.map((entry, index) => (
                          <div key={entry.name} className="flex items-center gap-1">
                            ...
                            />
                            <span className={`text-xs ${hasRegionData ? "text-gray-600" : "text-gray-400"}`}>
                          {entry.name}
                        </span>
                          </div>
                      ))}
                  ...
                  <div className="min-h-[200px] p-4 bg-transparent rounded-lg border">
                    <div className="text-xs font-small mb-2">
                      ...
                      {!hasStatusData && <span className="text-gray-400 ml-1">(Sem dados)</span>}
                    </div>
                    <div className="h-[120px] flex items-center justify-center">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                              ...
                              outerRadius="45%"
                              dataKey="value"
                              label={hasStatusData ? ({ percent }) => `${(percent * 100).toFixed(0)}%` : () => ""}
                          >
                          ...
                          <Tooltip content={<CustomTooltip hasData={hasStatusData} />} />
                        </PieChart>
                      </ResponsiveContainer>
                    </div>
                    <div className="flex flex-wrap justify-center gap-1 mt-2">
                      <div className="flex items-center gap-1">
                        ...
                        />
                        <span className={`text-xs ${hasStatusData ? "text-gray-600" : "text-gray-400"}`}>
                        Transações Aprovadas
                      </span>
                      </div>
                      <div className="flex items-center gap-1">
                        <div className="h-2 w-2 rounded-full bg-red-500" style={{ opacity: hasStatusData ? 1 : 0.3 }} />
                        <span className={`text-xs ${hasStatusData ? "text-gray-600" : "text-gray-400"}`}>
                        Transações Negadas
                      </span>
                      </div>
