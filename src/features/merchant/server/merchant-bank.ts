...
export type MerchantBankAccountInsert =
  typeof merchantBankAccounts.$inferInsert;
export type MerchantBankAccountUpdate =
  typeof merchantBankAccounts.$inferSelect;
