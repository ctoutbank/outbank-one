          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-zinc-600">Total de Consultores</span>
              </div>
              <span className="text-2xl font-semibold text-zinc-900 ml-4">{totalAgents}</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                ...
                <span className="text-base font-semibold text-zinc-900">{activeAgents}</span>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 mb-1.5">
                ...
                <span className="text-base font-semibold text-zinc-900">{inactiveAgents}</span>
              </div>
            </div>
          </CardContent>
        </Card>
